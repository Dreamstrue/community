...
<script type="text/javascript" charset="utf-8">
	function logout(){
		location.href='${pageContext.request.contextPath}/security/logout.action';
	}
...
<div style="position: absolute;left: 0px;top:0px;background: url('${pageContext.request.contextPath}/resources/images/banner_logo1.png') no-repeat;width:1002px;height:59px;"></div>
